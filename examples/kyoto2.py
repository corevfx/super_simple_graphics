...
def set_gradient():
    sg.set_brush_style_linear_gradient(w, h, 0, 0, r1=130, g1=200, b1=255, r2=120, g2=200, b2=255)
    sg.set_brush_gradient_color_at(0.4, 100, 73, 255)
    
def set_gradient_for_squares():
    sg.set_brush_style_linear_gradient(w/2, h/2, -w/2, -h/2, r1=183, g1=58, b1=255, r2=28, g2=5, b2=121)
...
for m in range(-20,21):
    for n in range(-20,21):
        ...
        sg.set_brush_style_linear_gradient(x-40,y-40,x+40,y+40,255,255,255,255,0,0)
