...
for n in range(10):
    if n>0:
        ...
        set_pen_color(0,0,0)
    draw_static_text(40,650-n*100-5,str(n*100))
    draw_line(80,650-n*100,720,650-n*100)
...
for key, value in data.items():
    ...
    draw_rect_with_rot_bl(i*50+100,650,45,value,0)
    # draw the month name
    set_pen_color(100,100,100)
    set_font_size(15)
    draw_static_text(i*50+110,650,key)
    # draw the monthly number
    set_font_size(10)
    draw_static_text(i*50+120,630-value,str(value))
    # calculate the total number by current month
    total_current = total_current + value
    # append it to the list
    total_by_month.append((i*50+125,650 - total_current))
    set_pen_color_hsv(240,180,170,180)
    set_pen_width(6)
    draw_point(i*50+125,650 - total_current)
    draw_static_text(i*50+125,650-total_current,str(total_current))
...
set_font_size(30)
draw_text(w/2,750,400,100,"Car Sales (2020)")
